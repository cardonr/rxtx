...
/**
 * 
 * connection COM1 (TX) <=> COM2 (RX)
 * 2400 bauds, parity none, bitstop 1, RTS ON
 *
 * TX send "hello world" and wait for reply
 * RX receive and check "hellow world" and reply with "OK" and stop.
 * TX receive "OK" and stop
 * 
 * @author Rodolphe
 */
public class TestRxTx {
    ...
    final static String MESSAGE1 = "Hello World";
    ...
    public static void main(String[] args) {
       try{
           ...
           while(en.hasMoreElements()){
               ...
               String portName = en.nextElement().getName();
               System.out.println(portName);
           }
           
           new Thread(new Tx()).start();
           new Thread(new Rx()).start();
