...
public class Rx implements Runnable {
    ...
    public void run() {
        try {
            ...
            int numOfBytes = 0;
            while (numOfBytes < TestRxTx.MESSAGE1.length()) {
            ...
            if (receivedStr.equals(TestRxTx.MESSAGE1)) {
                //OK
                System.out.println("Rx received message 1");
            ...
            os.write(TestRxTx.MESSAGE2.getBytes("UTF-8"));
            os.flush();

            is.close();
            System.out.println("Rx:is closed");

            os.close();
            System.out.println("Rx:os closed");
