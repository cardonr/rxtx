...
monThreadisInterrupted=false; //because a lot of functions check this
	...
	*/
	public InputStream getInputStream()
	{
		...
		//change by Cardon
                int bufferSize = 256;
                //BufferedInputStream bif = new BufferedInputStream(in, bufferSize);
                ThreadedBufferedInputStream bif = new ThreadedBufferedInputStream(in, bufferSize);
                return bif;
                //return in;
	}
	...
	*/
	...
	public void close()
	{
                ...
                //change by Cardon: don't check IOLocked: interruption will be done by C code when closing the port
		...
		public synchronized int available() throws IOException
		{
			...
			if ( monThreadisInterrupted == true )
			{
				return(0);
                        ...
                        //Cardon
                        System.err.println( "RXTXPort:available() called" );
			if ( debug_verbose )
